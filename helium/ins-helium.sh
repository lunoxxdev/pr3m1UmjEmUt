...
wget -q -O /usr/bin/wbmn https://raw.githubusercontent.com/hokagelegend2023/alpha3/main/helium/webmin/wbmn.sh
chmod +x /usr/bin/wbmn
rm -rf /usr/bin/helium
echo -e "\e[1;32m Start download Panel ADS Block.. \e[0m"
wget -q -O /usr/bin/helium https://raw.githubusercontent.com/hokagelegend2023/alpha3/main/helium/helium.sh
